...
class Petsc(Package, CudaPackage, ROCmPackage):
    ...
    with when("+rocm"):
        ...
        patch(
            "https://raw.githubusercontent.com/spack/spack/2e2169d5282d166f63e3ee4db8d4446c43cefa8a/var/spack/repos/builtin/packages/petsc/hip-5.6.0-for-3.18.diff",
            when="@3.18:3.19 ^hipsparse@5.6.0",
            sha256="e89bfc32193c1b3bfcd481bb9012c48f9cc6bfc4fe1b4a5ba494694e5a98457a",
        )
        patch(
            "https://raw.githubusercontent.com/spack/spack/2e2169d5282d166f63e3ee4db8d4446c43cefa8a/var/spack/repos/builtin/packages/petsc/hip-5.7-plus-for-3.18.diff",
            when="@3.18:3.19 ^hipsparse@5.7:",
            sha256="95e8251e5a5d798320cace85e5d84770f7c0ec35643e4c782f7e1e72ba09c3e7",
        )
        patch(
            "https://raw.githubusercontent.com/spack/spack/2e2169d5282d166f63e3ee4db8d4446c43cefa8a/var/spack/repos/builtin/packages/petsc/0001-Handle-the-hipsparse-api-changes-for-rocm-6.0.patch",
            when="@3.20.2:3.20.4 ^hipsparse@6.0",
            sha256="268055d681132358c9fd805c87e345a1c271388350a0c772c62e749306f31619",
        )
    ...
    patch(
        "https://raw.githubusercontent.com/spack/spack/2e2169d5282d166f63e3ee4db8d4446c43cefa8a/var/spack/repos/builtin/packages/petsc/disable-DEPRECATED_ENUM.diff",
        when="@3.14.1 +cuda",
        sha256="e04bd7afe3d4aa40debf6600b46b64de82d9e62a774d8ef63c922601fec7fc90",
    )
    patch(
        "https://raw.githubusercontent.com/spack/spack/2e2169d5282d166f63e3ee4db8d4446c43cefa8a/var/spack/repos/builtin/packages/petsc/revert-3.18.0-ver-format-for-dealii.patch",
        when="@3.18.0",
        sha256="2daeca79571173f5756ef3397232469e9188ed69c50891516a114797de9aaba8",
    )
    patch(
    ...
    depends_on("hypre~internal-superlu", when="+hypre ^hypre@:2.12.1")
